export const SKILLS = {
  ...
  yes_no_questions: { label: 'Yes/No questions', labelVi: 'Câu hỏi Yes/No' },
...
const lessonSkillMap = {
  ...
  'f05': ['sentence_subject', 'sentence_verb'], 'f06': ['sentence_subject'], 'f07': ['sentence_verb'], 'f08': ['sentence_subject','sentence_verb'],
